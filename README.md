...
* **AI Engineer (My Core Class):** I specialize in the complete end-to-end AI/ML lifecycle, from data analysis and model training (PyTorch, TensorFlow, YOLO) to MLOps (DVC, MLflow) and deployment across diverse platforms, from cloud servers to edge devices like Android and Jetson. I think about `How can I get this to my users?`
...
<p align="center">
  ...
  <a href="https://github.com/erwincarlogonzales/mldetection_data_analysis">
    ...
    <img src="https://github-readme-stats.vercel.app/api/pin/?username=erwincarlogonzales&repo=mldetection_jetson&theme=tokyonight" alt="Edge AI (Jetson Nano) ML Project">
  </a>
...
Be sure to check out my other pinned repos for projects on Edge AI (Jetson Nano) and more!
